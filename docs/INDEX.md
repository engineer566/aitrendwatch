...
├── tracker.py      # 热词追踪层：HF 模型榜 + arXiv 论文检索（621 行；2026-09-05：community_links 按语言分流 zh 知乎/B站/GitHub en YouTube/GitHub + localize_model_cards 读取时投影）
