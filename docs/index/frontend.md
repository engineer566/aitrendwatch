...
## templates/index.html  （1564 行）— 首页主单页（词视图为主）
...
## templates/hf.html  （377 行）— HuggingFace 独立排序页（开源动向）
...
## templates/term_detail.html  （322 行）— 通用热词聚合页
...
## templates/search.html  （527 行）— 搜索结果页（含热词命中）
